...
const ShowSkill = ({skill}) => {
    ...
    return (
        <div data-aos="flip-up" className='hover down flex flex-col justify-center items-center px-3 py-2 my-0 mx-auto mb-5 mt-20 bg-mainBg border-2 border-mainFont rounded-lg w-[200px] h-[250px] gap-3 relative overflow-hidden z-0'>
