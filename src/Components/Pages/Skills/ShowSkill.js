...
const ShowSkill = ({skill}) => {
    ...
    return (
        <div className='hover down flex flex-col justify-center items-center px-3 py-2 my-0 mx-auto mb-5 mt-20 bg-mainBg border-2 border-mainFont rounded-lg w-[170px] h-[220px] gap-3 relative overflow-hidden z-0'>
