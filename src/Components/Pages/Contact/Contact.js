...
const Contact = () => {
  ...
  return (
    ...
    <div id='contact' className='h-screen'>
      ...
      <div data-aos="fade-up">
        <form ref={form} action="" className='flex flex-col justify-center items-center px-1 mt-20 md:mt-40'>
          {/* name */}
          ...
          {/* Message  */}
          <div className='w-[85%] md:w-[30%] h-[100px] mt-1 flex justify-center items-center'>
          ...
          <input type="submit" value="Send" className="shade w-[85%] md:w-[30%] mt-2 h-full rounded-md border-2 px-2 py-1 pl-5 text-[24px] font-fancy tracking-wider text-mainFont bg-mainBg mb-2 mr-1 placeholder:text-mainFont outline-none"/>
        </form>
      </div>
    </div>
    // </Animation>
